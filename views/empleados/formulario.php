...
<div class="card form-container">
    ...
    <form method="POST" action="index.php?page=empleados&accion=guardar">
        ...
        <div class="form-group">
            ...
            <select name="supervisor_legajo" class="form-control">
                <option value="">Sin supervisor</option>
                <?php foreach ($supervisores as $sup): ?>
                    <?php if ($sup['legajo'] == ($empleado['legajo'] ?? -1)) continue; ?>
                    <option value="<?= $sup['legajo'] ?>"
                        <?= ($empleado['supervisor_legajo'] ?? '') == $sup['legajo'] ? 'selected' : '' ?>>
